...
import xyz.imlent.wfe.core.model.IResultCode;
import xyz.imlent.wfe.core.model.R;
import xyz.imlent.wfe.core.model.ResultCode;
...
public class GlobleExceptionController {
    ...
    public R handleError(FeignException e, HttpServletResponse response) {
        String msg = e.getMessage();
        if (StringUtils.isBlank(msg)) {
            msg = ResultCode.getMsg(e.status());
        }
        log.error("feign异常:{}", msg);
